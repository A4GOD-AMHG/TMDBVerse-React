...
const MovieDetails = () => {
    ...
    return (
        <div className="min-h-screen overflow-hidden bg-primary text-white pb-12">
            {isLoading ? <Spinner />
                : error ? <div className="text-red-500 text-center mt-8">{error}</div>
                    : <>
                        <div
                            className="wrapper z-0 h-64 md:h-[30vh] bg-cover bg-center relative"
                            style={{
                            ...
                            <div className="flex flex-col md:flex-row gap-8">
                                <div className="hidden md:block md:w-1/3 lg:w-1/4">
                                    <img
                                        ...
                                        alt={movie?.title}
                                        className="w-full h-auto rounded-lg shadow-xl -mt-8 z-20"
                                    />
                                </div>
